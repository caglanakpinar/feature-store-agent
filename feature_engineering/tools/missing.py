...
with those and register into the same catalogue under `impute_*` names:
    ...
    from feature_engineering.tools.missing import impute_auto, missing_profile
